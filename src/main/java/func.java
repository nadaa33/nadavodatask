...
public class func {
   ...
   // JavascriptExecutor jse = (JavascriptExecutor)driver;
    ...
    public static void SetupChromedriver()
    {
            ...
            System.setProperty("webdriver.chrome.driver", "/Users/228999/Desktop/vodatask/chromedriver(1).exe");
    ...
    public  void registration()
    {
      ...
      WebElement SignIn;
        ...
        mail.sendKeys("nadaessam777@gmail.com");
        ...
        lastName.sendKeys("Essam");

        WebElement password = driver.findElement(By.id("passwd"));
        password.sendKeys("12345N");
        ...
        address.sendKeys("newcairo");

        WebElement address2 = driver.findElement(By.id("address2"));
        address2.sendKeys("329");
        ...
        additionalinfo.sendKeys("01140576575");
    ...
    public void Checkout()
    {
        ...
        Email.sendKeys("nadaessa777@gmail.com");
